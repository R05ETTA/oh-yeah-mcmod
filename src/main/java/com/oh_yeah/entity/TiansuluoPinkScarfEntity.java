...
public class TiansuluoPinkScarfEntity extends AbstractTiansuluoEntity implements RangedAttackMob {
    ...
    public TiansuluoPinkScarfEntity(EntityType<? extends AnimalEntity> entityType, World world) {
    ...
    public @Nullable PassiveEntity createChild(ServerWorld serverWorld, PassiveEntity passiveEntity) {
        TiansuluoPinkScarfEntity child = ModEntityTypes.TIANSULUO_PINK_SCARF.create(serverWorld);
        if (child != null) {
            child.setBaby(true);
    ...
    protected SpeciesConfig speciesConfig() {
        return OhYeahConfigManager.getTiansuluoPinkScarfConfig();
    }

    @Override
    protected String soundProfileKey() {
        return ModSpeciesProfiles.TIANSULUO_PINK_SCARF_SOUND_PROFILE;
    }
